...
class LexerTest {
    ...
    void testNextToken() {
        ...
        List<Token> expectedList = List.of(
                ...
                // 5 < x < 10
                new Token(TokenType.NUMBER, "5", 8, 1),
                ...
                // "Hello World!"
                new Token(TokenType.STRING, "Hello World!", 17, 1),
                new Token(TokenType.NEWLINE, "\n", 17, 15),

                // f(x) = x + 10
                new Token(TokenType.IDENT, "f", 18, 1),
                ...
                // abs(x) = case x < 0 -> -x, x >= 0 -> x
                new Token(TokenType.IDENT, "abs", 19, 1),
                ...
                // fib(x) =
                new Token(TokenType.IDENT, "fib", 20, 1),
                ...
                // ....case
                new Token(TokenType.CASE, "case", 21, 5),
                new Token(TokenType.NEWLINE, "\n", 21, 9),

                // ....x == 0 -> 0,
                new Token(TokenType.IDENT, "x", 22, 5),
                ...
                // ....x == 1 -> 1,
                new Token(TokenType.IDENT, "x", 23, 5),
                ...
                // ....default -> fib(x - 2) + fib(x - 1)
                new Token(TokenType.DEFAULT, "default", 24, 5),
